...
//		spring 적용
		final ApplicationContext context = new AnnotationConfigApplicationContext(BankStatementConfig.class);
//		컨테이너 생성
		final BankStatementParser bankStatementParser = context.getBean(BankStatementTSVParser.class);
//		의존성(Bean)꺼냄
